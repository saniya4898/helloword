...
class Header
{
    ...
    public static $httpResponseCode = array(
        // INFORMATIONAL CODES
        100 => 'Continue',
    ...
    public static function setCookie(array $cookie = array())
    {
    ...
    public static function validate($account, $msg = 'Welcome to Cpanel, Please enter the authentication key as the login.')
    {
